    ...
    public sealed partial class VideoPlayer : UserControl
    {
        ...
        private async Task SendDanmaku()
        {
            ...
            if (!string.IsNullOrEmpty(text))
            {
                ...
                if (result)
                {
                    ...
                    if (mode == "1")
                        DanmakuControls.AddScrollDanmu(new DanmakuModel { color = ColorHelper.ToColor(ColorTextBox.Text), size = fontSizeNum, text = text }, true);
                    else if (mode == "4")
        ...
        private void FontSizeSlider_ValueChanged(object sender, RangeBaseValueChangedEventArgs e)
        {
            if (_isDanmakuOptionsInit)
            {
                ...
                DanmakuControls.DanmakuSizeZoom=v;
        ...
        private void SpeedSlider_ValueChanged(object sender, RangeBaseValueChangedEventArgs e)
        {
            if (_isDanmakuOptionsInit)
            {
                ...
                DanmakuControls.DanmakuDuration = 25 - Convert.ToInt32(v * 12);
        ...
        private void FontComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (_isDanmakuOptionsInit)
            {
                ...
                if (item.Name != oldFont)
                {
                    ...
                    DanmakuControls.DanmakuFontFamily = item.Name;
                    try
                    {
        ...
        private void BorderStyleComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (_isDanmakuOptionsInit)
            {
                ...
                if (index == -1)
                    return;
                DanmakuControls.DanmakuStyle = (DanmakuBorderStyle)index;
        ...
        private void VideoMTC_DanmakuLoaded(object sender, NSDanmaku.Controls.Danmaku e)
        {
            ...
            DanmakuControls.DanmakuSizeZoom = danmakuSize;
            ...
            DanmakuControls.DanmakuDuration = 25 - Convert.ToInt32(12 * danmakuSpeed);
            FontInit();
            ...
            DanmakuControls.DanmakuStyle = (DanmakuBorderStyle)borderStyle;
            ...
            DanmakuControls.InitializeComponent();
                            ...
                            if (!IsTextShouldShield(item.text))
                            {
                                switch (item.location)
                                {
                                    ...
                                    case DanmakuLocation.Position:
                                        ...
                                        break;
                                    default:
                                        DanmakuControls.AddScrollDanmu(item, false);
                                        break;
                                }
                                nowDanmaNum++;
                            }
        ...
        private void FontInit()
        {
            ...
            if (FontCollection != null && FontCollection.Count > 0)
            {
                ...
                if (font != null)
                {
                    ...
                    DanmakuControls.DanmakuFontFamily = fontName;
                    try
                    {
